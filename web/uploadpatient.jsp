...
<html>
    ...
    <body>
        <%
            ...
            String c = "jdbc:mysql://localhost:3308/mfas";
            ...
            try{
                ...
                if(filepart != null)
                {
                    ...
                    String sql = "INSERT INTO doctor(f_name,l_name,username,email,pass,dob,gender,addr,country,city,state,postalcode,phone,photo,short_bio,status) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
