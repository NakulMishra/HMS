<%-- 
    ...
    Created on : 14 Sep, 2023, 10:25:11 AM
    Author     : hp
--%>
...
<html lang="en">
  ...
  <th>Action</th>
                                    ...
                                    <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit-appointment.jsp?id=<%=rs.getString("app_id")%>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item" href="delete-appointment.jsp?id=<%=rs.getString("app_id")%>" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                            </div>
                                    </div>
                            </td>
