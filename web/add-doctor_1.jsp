<%-- 
    Document   : add-doctor_1
    Created on : 14 Sep, 2023, 10:35:43 AM
    Author     : hp
--%>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="uploadDocImage"  method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" cols="30" name="short_bio"></textarea>
                                </div>
                                <div class="form-group">
