<%-- 
    ...
    Created on : 13 Sep, 2023, 11:45:24 AM
    Author     : hp
--%>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    ...
                                    <li><a href="add-appointment.jsp">View Appointment</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="f_name">
                                                ...
                                                <%
                                                    ...
                                                    ResultSet rs = st.executeQuery("SELECT f_name from patient");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select" name="doctor">
                                                ...
                                                <%
                                                    ...
                                                    ResultSet rs1 = st1.executeQuery("SELECT f_name from doctor");

                                                    while (rs1.next()) {
                                                %>
                                                <option><%=rs1.getString("f_name")%></option>
                                                <%
                                                    }
                                                %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="patient_phn_no">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
