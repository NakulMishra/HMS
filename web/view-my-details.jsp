<%-- 
    Document   : view-my-details
    Created on : 20 Sep, 2023, 3:11:03 PM
    Author     : hp
--%>
                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="doctors-for-patient.jsp"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                            </li>
            ...
            <div class="page-wrapper">
                <div class="content">
                    ...
                    <%
                        ...
                        ResultSet rs = null;
                        String sql = null;
                        String patient_id = (String) session.getAttribute("user");
                        sql = "SELECT * FROM patient WHERE username='" + patient_id+ "'";
