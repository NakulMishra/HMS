                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="admit-patient.jsp"><i class="fa fa-wheelchair"></i> <span>Admit Patient</span></a>
                            </li>
                            <li>
                                <a href="discharge-patient.jsp"><i class="fa fa-wheelchair"></i> <span>Discharge Patient</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
