<%-- 
    Document   : view-appointment-doc
    Created on : 15 Sep, 2023, 10:21:29 AM
    Author     : hp
--%>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul style="display: none;">
                                    <li><a href="view-appointment-doc.jsp">View Appointment</a></li>
                                ...
                                <table class="table table-border table-striped custom-table datatable mb-0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=rs.getString("patient_phn_no")%></td>
                                            <td class="text-right">
